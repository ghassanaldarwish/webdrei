...
export default function Logo({ className }: { className?: string }) {
  return (
    <svg
      className={cn(
        "  bg bg-zinc-800 text-3xl rounded-full w-12 h-12",
        className
      )}
      viewBox="0 0 216 208"
      fill="none"
    ...
    >
      ...
      <rect
        width="10.3932"
        height="28.5311"
        transform="matrix(-0.813389 0.58172 -0.586075 -0.810257 111 159)"
        fill="url(#paint2_linear_1_2)"
      />
      <rect
        width="10.3884"
        height="28.5442"
        transform="matrix(0.762056 0.647512 -0.651761 0.758424 104 39)"
        fill="url(#paint3_linear_1_2)"
      />
      <path
        d="M78.88 145V61.16H100.768C113.653 61.16 123.595 64.7013 130.592 71.784C137.675 78.7813 141.216 89.1067 141.216 102.76C141.216 116.413 137.717 126.867 130.72 134.12C123.723 141.373 113.995 145 101.536 145H78.88ZM92.32 134.12H99.872C118.219 134.12 127.392 123.667 127.392 102.76C127.392 82.28 118.219 72.04 99.872 72.04H92.32V134.12Z"
